...
export default function BriefMore(props) {
  return (
    <>
      <a
        href="/"
        className={`brief--content--more ${props.brdr} cursor-default p-4 bg-clr_white_1 flex max-w-[328px] rounded-[8px]`}
      >
        <div className="more_bg_gradient cursor-pointer">
          <img src={logo_shape} alt="" />
        </div>
        <div className="more--text grid">
          <p className="pb-2 text-[14px] text-primary leading-[18px]">
